...
class _AnalyzePageState extends State<AnalyzePage> {
  ...
  Future<void> _fetchSearchHistory() async {
    try {
      final response = await http.get(Uri.parse('http://localhost:8000/search_history?AccountID=$loggedInAccountID'));
  ...
  Future<void> _performSearch() async {
    ...
    switch (_selectedOption) {
      case 'URL':
        apiUrl = 'http://localhost:8000/api/analyze/link';
        body = {'url': input};
        break;
      case 'MSG':
        apiUrl = 'http://localhost:8000/api/analyze/message';
        body = {'msg': input};
        break;
      default:
        apiUrl = 'http://localhost:8000/api/analyze/message';
  ...
  Future<void> _addHistory({
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://localhost:8000/add_history'),
        headers: {"Content-Type": "application/json"},
